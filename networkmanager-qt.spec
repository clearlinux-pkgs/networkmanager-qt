...
Version  : 6.7.0
Release  : 89
URL      : https://download.kde.org/stable/frameworks/6.7/networkmanager-qt-6.7.0.tar.xz
Source0  : https://download.kde.org/stable/frameworks/6.7/networkmanager-qt-6.7.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/6.7/networkmanager-qt-6.7.0.tar.xz.sig
...
%setup -q -n networkmanager-qt-6.7.0
cd %{_builddir}/networkmanager-qt-6.7.0
pushd ..
cp -a networkmanager-qt-6.7.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1728694641
mkdir -p clr-build
pushd clr-build
