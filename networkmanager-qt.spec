...
Version  : 5.48.0
Release  : 1
URL      : https://download.kde.org/stable/frameworks/5.48/networkmanager-qt-5.48.0.tar.xz
Source0  : https://download.kde.org/stable/frameworks/5.48/networkmanager-qt-5.48.0.tar.xz
Source99 : https://download.kde.org/stable/frameworks/5.48/networkmanager-qt-5.48.0.tar.xz.sig
...
Group: Development
Requires: networkmanager-qt-lib
Provides: networkmanager-qt-devel
...
%prep
%setup -q -n networkmanager-qt-5.48.0
...
export LANG=C
export SOURCE_DATE_EPOCH=1532446017
mkdir clr-build
pushd clr-build
%cmake ..
make  %{?_smp_mflags}
...
%files lib
%defattr(-,root,root,-)
/usr/lib64/libKF5NetworkManagerQt.so.5.48.0
/usr/lib64/libKF5NetworkManagerQt.so.6

%files license
%defattr(-,root,root,-)
/usr/share/doc/networkmanager-qt/COPYING.LIB
