...
Source0  : https://download.kde.org/stable/frameworks/6.5/networkmanager-qt-6.5.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/6.5/networkmanager-qt-6.5.0.tar.xz.sig
...
%setup -q -n networkmanager-qt-6.5.0
cd %{_builddir}/networkmanager-qt-6.5.0
pushd ..
cp -a networkmanager-qt-6.5.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1723236521
mkdir -p clr-build
pushd clr-build
