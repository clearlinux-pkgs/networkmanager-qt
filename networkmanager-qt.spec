...
Source0  : https://download.kde.org/stable/frameworks/5.60/networkmanager-qt-5.60.0.tar.xz
Source99 : https://download.kde.org/stable/frameworks/5.60/networkmanager-qt-5.60.0.tar.xz.sig
...
%prep
%setup -q -n networkmanager-qt-5.60.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1563048472
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/usr/lib64/libKF5NetworkManagerQt.so.5.60.0
