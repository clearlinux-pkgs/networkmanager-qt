...
Version  : 5.106.0
Release  : 63
URL      : https://download.kde.org/stable/frameworks/5.106/networkmanager-qt-5.106.0.tar.xz
Source0  : https://download.kde.org/stable/frameworks/5.106/networkmanager-qt-5.106.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/5.106/networkmanager-qt-5.106.0.tar.xz.sig
...
%prep
%setup -q -n networkmanager-qt-5.106.0
cd %{_builddir}/networkmanager-qt-5.106.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1684808899
mkdir -p clr-build
pushd clr-build
...
%files dev
%defattr(-,root,root,-)
/V3/usr/lib64/libKF5NetworkManagerQt.so
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libKF5NetworkManagerQt.so.5.106.0
/V3/usr/lib64/libKF5NetworkManagerQt.so.6
/usr/lib64/libKF5NetworkManagerQt.so.5.106.0
