...
Version  : 5.55.0
Release  : 12
URL      : https://download.kde.org/stable/frameworks/5.55/networkmanager-qt-5.55.0.tar.xz
Source0  : https://download.kde.org/stable/frameworks/5.55/networkmanager-qt-5.55.0.tar.xz
Source99 : https://download.kde.org/stable/frameworks/5.55/networkmanager-qt-5.55.0.tar.xz.sig
...
%prep
%setup -q -n networkmanager-qt-5.55.0
...
export LANG=C
export SOURCE_DATE_EPOCH=1549731669
mkdir -p clr-build
pushd clr-build
%cmake ..
make  %{?_smp_mflags}
...
%files lib
%defattr(-,root,root,-)
/usr/lib64/libKF5NetworkManagerQt.so.5.55.0
