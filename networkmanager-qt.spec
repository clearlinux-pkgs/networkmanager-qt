...
Version  : 5.108.0
Release  : 66
URL      : https://download.kde.org/stable/frameworks/5.108/networkmanager-qt-5.108.0.tar.xz
Source0  : https://download.kde.org/stable/frameworks/5.108/networkmanager-qt-5.108.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/5.108/networkmanager-qt-5.108.0.tar.xz.sig
...
%prep
%setup -q -n networkmanager-qt-5.108.0
cd %{_builddir}/networkmanager-qt-5.108.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1688867255
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libKF5NetworkManagerQt.so.5.108.0
/usr/lib64/libKF5NetworkManagerQt.so.5.108.0
