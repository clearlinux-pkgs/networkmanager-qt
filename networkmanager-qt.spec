...
Version  : 5.59.0
Release  : 18
URL      : https://download.kde.org/stable/frameworks/5.59/networkmanager-qt-5.59.0.tar.xz
Source0  : https://download.kde.org/stable/frameworks/5.59/networkmanager-qt-5.59.0.tar.xz
Source99 : https://download.kde.org/stable/frameworks/5.59/networkmanager-qt-5.59.0.tar.xz.sig
...
%prep
%setup -q -n networkmanager-qt-5.59.0
...
export LANG=C
export SOURCE_DATE_EPOCH=1560020079
mkdir -p clr-build
pushd clr-build
export AR=gcc-ar
...
%files lib
%defattr(-,root,root,-)
/usr/lib64/libKF5NetworkManagerQt.so.5.59.0
