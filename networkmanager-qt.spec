...
Version  : 6.2.0
Release  : 82
URL      : https://download.kde.org/stable/frameworks/6.2/networkmanager-qt-6.2.0.tar.xz
Source0  : https://download.kde.org/stable/frameworks/6.2/networkmanager-qt-6.2.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/6.2/networkmanager-qt-6.2.0.tar.xz.sig
...
%setup -q -n networkmanager-qt-6.2.0
cd %{_builddir}/networkmanager-qt-6.2.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1715624929
mkdir -p clr-build
pushd clr-build
