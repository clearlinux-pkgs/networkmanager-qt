...
Version  : 5.97.0
Release  : 53
URL      : https://download.kde.org/stable/frameworks/5.97/networkmanager-qt-5.97.0.tar.xz
Source0  : https://download.kde.org/stable/frameworks/5.97/networkmanager-qt-5.97.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/5.97/networkmanager-qt-5.97.0.tar.xz.sig
...
%prep
%setup -q -n networkmanager-qt-5.97.0
cd %{_builddir}/networkmanager-qt-5.97.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1660514508
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/usr/lib64/libKF5NetworkManagerQt.so.5.97.0
