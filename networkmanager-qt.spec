...
Version  : 6.0.0
Release  : 78
URL      : https://download.kde.org/stable/frameworks/6.0/networkmanager-qt-6.0.0.tar.xz
Source0  : https://download.kde.org/stable/frameworks/6.0/networkmanager-qt-6.0.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/6.0/networkmanager-qt-6.0.0.tar.xz.sig
...
%prep
%setup -q -n networkmanager-qt-6.0.0
cd %{_builddir}/networkmanager-qt-6.0.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1711145499
mkdir -p clr-build
pushd clr-build
