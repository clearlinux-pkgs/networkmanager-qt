...
Version  : 5.89.0
Release  : 45
URL      : https://download.kde.org/stable/frameworks/5.89/networkmanager-qt-5.89.0.tar.xz
Source0  : https://download.kde.org/stable/frameworks/5.89/networkmanager-qt-5.89.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/5.89/networkmanager-qt-5.89.0.tar.xz.sig
...
%prep
%setup -q -n networkmanager-qt-5.89.0
cd %{_builddir}/networkmanager-qt-5.89.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1639675124
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/networkmanager-qt-5.89.0/LICENSES/BSD-3-Clause.txt %{buildroot}/usr/share/package-licenses/networkmanager-qt/9950d3fdce1cff1f71212fb5abd31453c6ee2f8c
cp %{_builddir}/networkmanager-qt-5.89.0/LICENSES/CC0-1.0.txt %{buildroot}/usr/share/package-licenses/networkmanager-qt/82da472f6d00dc5f0a651f33ebb320aa9c7b08d0
cp %{_builddir}/networkmanager-qt-5.89.0/LICENSES/GPL-2.0-only.txt %{buildroot}/usr/share/package-licenses/networkmanager-qt/2a638514c87c4923c0570c55822620fad56f2a33
cp %{_builddir}/networkmanager-qt-5.89.0/LICENSES/GPL-3.0-only.txt %{buildroot}/usr/share/package-licenses/networkmanager-qt/6091db0aead0d90182b93d3c0d09ba93d188f907
cp %{_builddir}/networkmanager-qt-5.89.0/LICENSES/LGPL-2.1-only.txt %{buildroot}/usr/share/package-licenses/networkmanager-qt/3c3d7573e137d48253731c975ecf90d74cfa9efe
cp %{_builddir}/networkmanager-qt-5.89.0/LICENSES/LGPL-3.0-only.txt %{buildroot}/usr/share/package-licenses/networkmanager-qt/757b86330df80f81143d5916b3e92b4bcb1b1890
cp %{_builddir}/networkmanager-qt-5.89.0/LICENSES/LicenseRef-KDE-Accepted-GPL.txt %{buildroot}/usr/share/package-licenses/networkmanager-qt/7d9831e05094ce723947d729c2a46a09d6e90275
cp %{_builddir}/networkmanager-qt-5.89.0/LICENSES/LicenseRef-KDE-Accepted-GPL.txt %{buildroot}/usr/share/package-licenses/networkmanager-qt/7d9831e05094ce723947d729c2a46a09d6e90275
cp %{_builddir}/networkmanager-qt-5.89.0/LICENSES/LicenseRef-KDE-Accepted-LGPL.txt %{buildroot}/usr/share/package-licenses/networkmanager-qt/e458941548e0864907e654fa2e192844ae90fc32
cp %{_builddir}/networkmanager-qt-5.89.0/LICENSES/LicenseRef-KDE-Accepted-LGPL.txt %{buildroot}/usr/share/package-licenses/networkmanager-qt/e458941548e0864907e654fa2e192844ae90fc32
pushd clr-build
%make_install
popd
...
%files lib
%defattr(-,root,root,-)
/usr/lib64/libKF5NetworkManagerQt.so.5.89.0
